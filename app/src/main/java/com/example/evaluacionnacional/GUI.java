...
public class GUI extends AppCompatActivity {
    ...
    static String MQTTHOST = "tcp://proyectos-sas-mqtt.cloud.shiftr.io:1883";
    static String USERNAME = "proyectos-sas-mqtt";
    static String PASSWORD = "xe0OJWH0oVNQZuF4";
